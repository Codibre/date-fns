...
describe('differenceInCalendarWeeks', () => {
    it('returns the number of calendar weeks between the given dates', () => {
        const result = differenceInCalendarWeeks(new Date(2014, 6 /* Jul */, 8, 18, 0), new Date(2014, 5 /* Jun */, 29, 6, 0));
        assert(result === 1);
    });
    it('allows to specify which day is the first day of the week', () => {
        const result = differenceInCalendarWeeks(new Date(2014, 6 /* Jul */, 8, 18, 0), new Date(2014, 5 /* Jun */, 29, 6, 0), { weekStartsOn: 1 });
        assert(result === 2);
    });
    ...
    it('returns a negative number if the time value of the first date is smaller', () => {
        const result = differenceInCalendarWeeks(new Date(2014, 5 /* Jun */, 29, 6, 0), new Date(2014, 6 /* Jul */, 8, 18, 0));
        assert(result === -1);
    });
    it('accepts timestamps', () => {
        const result = differenceInCalendarWeeks(new Date(2014, 6 /* Jul */, 12).getTime(), new Date(2014, 6 /* Jul */, 2).getTime());
        assert(result === 1);
    });
    describe('edge cases', () => {
        ...
        it('the given dates are the same', () => {
            const result = differenceInCalendarWeeks(new Date(2014, 8 /* Sep */, 5, 0, 0), new Date(2014, 8 /* Sep */, 5, 0, 0));
            assert(result === 0);
        });
