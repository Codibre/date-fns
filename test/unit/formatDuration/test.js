...
describe('formatDuration', () => {
    ...
    it('allows to customize the format', () => {
        assert(formatDuration({
            ...
            minutes: 9,
            seconds: 30,
        }, { format: ['months', 'weeks'] }) === '9 months 1 week');
    });
    ...
    it('allows to include zeros', () => {
        assert(formatDuration({
            ...
            minutes: 0,
            seconds: 0,
        }, { zero: true }) === '0 years 0 months 1 week 0 days 0 hours 0 minutes 0 seconds');
    });
    it('allows to customize the delimiter', () => {
        assert(formatDuration({ months: 9, days: 2 }, { delimiter: ', ' }) ===
            '9 months, 2 days');
    });
});
