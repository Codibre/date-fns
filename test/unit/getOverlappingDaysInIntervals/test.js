...
describe('getOverlappingDaysInIntervals', () => {
    ...
    describe("when the time intervals don't overlap", () => {
        it('returns 0 for a valid non overlapping interval before another interval', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: earlierIntervalStart, end: earlierIntervalEnd });
        ...
        it('returns 0 for a valid non overlapping interval after another interval', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: laterIntervalStart, end: laterIntervalEnd });
            assert(numOverlappingDays === 0);
        });
        it('returns 0 for a non overlapping same-day interval', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: sameDayIntervalStart, end: sameDayIntervalEnd });
            assert(numOverlappingDays === 0);
        });
        it('returns 0 for an interval differing by a few hours', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, {
        ...
        it("returns 0 for an interval with the same startDateTime as the initial time intervals's endDateTime", () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: oneDayOverlapIntervalStart, end: oneDayOverlapIntervalEnd });
            assert(numOverlappingDays === 0);
        });
    ...
    describe('when the time intervals overlap', () => {
        it('rounds up the result to include each started overlapping day', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: includedIntervalStart, end: includedIntervalEnd });
        ...
        it('returns the correct value for an interval overlapping at the end', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: endOverlappingIntervalStart, end: endOverlappingIntervalEnd });
        ...
        it('returns the correct value for an interval including another interval', () => {
            ...
            const numOverlappingDays = getOverlappingDaysInIntervals({ start: initialIntervalStart, end: initialIntervalEnd }, { start: includingIntervalStart, end: includingIntervalEnd });
    ...
    it('throws an exception if the start date of the initial time interval is after the end date', () => {
        const block = getOverlappingDaysInIntervals.bind(null, { start: new Date(2016, 10, 7), end: new Date(2016, 10, 3) }, { start: new Date(2016, 10, 5), end: new Date(2016, 10, 15) });
        assert.throws(block, RangeError);
    });
    it('throws an exception if the start date of the compared time interval is after the end date', () => {
        const block = getOverlappingDaysInIntervals.bind(null, { start: new Date(2016, 10, 3), end: new Date(2016, 10, 7) }, { start: new Date(2016, 10, 15), end: new Date(2016, 10, 5) });
        assert.throws(block, RangeError);
    });
    describe('one of the dates is `Invalid Date`', () => {
        it('throws an exception if the start date of the initial time interval is `Invalid Date`', () => {
            const block = getOverlappingDaysInIntervals.bind(null, { start: new Date(NaN), end: new Date(2016, 10, 3) }, { start: new Date(2016, 10, 5), end: new Date(2016, 10, 15) });
            assert.throws(block, RangeError);
        });
        it('throws an exception if the end date of the initial time interval is `Invalid Date`', () => {
            const block = getOverlappingDaysInIntervals.bind(null, { start: new Date(2016, 10, 3), end: new Date(NaN) }, { start: new Date(2016, 10, 5), end: new Date(2016, 10, 15) });
            assert.throws(block, RangeError);
        });
        it('throws an exception if the start date of the compared time interval is `Invalid Date`', () => {
            const block = getOverlappingDaysInIntervals.bind(null, { start: new Date(2016, 10, 3), end: new Date(2016, 10, 7) }, { start: new Date(NaN), end: new Date(2016, 10, 5) });
            assert.throws(block, RangeError);
        });
        it('throws an exception if the end date of the compared time interval is `Invalid Date`', () => {
            const block = getOverlappingDaysInIntervals.bind(null, { start: new Date(2016, 10, 3), end: new Date(2016, 10, 7) }, { start: new Date(2016, 10, 5), end: new Date(NaN) });
            assert.throws(block, RangeError);
        });
    });
});
